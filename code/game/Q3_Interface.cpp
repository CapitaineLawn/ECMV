...
stringID_table_t WPTable[] =
{
	...
	ENUM2STRING(WP_DROIDBLASTER),	// Roger Roger
	ENUM2STRING(WP_CLONERIFLE),		// Copy That
	ENUM2STRING(WP_REBELRIFLE),		// Save the Rebellion ! Save the dream..
	{ "", 0 }
};
...
stringID_table_t setTable[] =
{
	...
	ENUM2STRING(SET_FORCE_ELEMENTS_LEVEL),
	...
	ENUM2STRING(SET_FORCE_ELEMENTS),
...
extern void Saboteur_Cloak( gentity_t *self );
	...
	case SET_FORCE_LIGHTNING:
		...
		break;
	case SET_FORCE_ELEMENTS:
		Q3_SetForcePower(entID, FP_ELEMENTS, (qboolean)(Q_stricmp("true", (char*)data) == 0));
		break;
